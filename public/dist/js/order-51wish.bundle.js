...
//51wish lean App Header
window.leanAppHeader = {
    'x-lc-id': 'QuiPuWpJPzCahsgBK7teBOJN-gzGzoHsz',
    'x-lc-sign': '489879933bc318c0c23a44f2f40dcc4f,1471851738840',
...
},{"../../../js/main":17,"./common":1,"./config":2}],4:[function(require,module,exports){
'use strict';
...
require('swfobject');
require('typeahead');
},{"amazeui":5,"flash-detect":7,"jquery":13,"jquery-cookie":8,"jquery-datetimepicker":9,"jquery-form":10,"jquery-jcarousel":11,"jquery-lazyload":12,"jquery-validate":14,"jquery-zclip":15,"jquery-zoom":16,"swfobject":18,"typeahead":19,"underscore":20}],18:[function(require,module,exports){
(function (global){
; var __browserify_shim_require__=require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
...
},{"./lib/product-preview":4,"jquery-validate":14}],"customer":[function(require,module,exports){
'use strict';
...
},{"bloodhound":6,"jquery-validate":14}],"earning":[function(require,module,exports){
'use strict';
...
},{"jquery-validate":14}],"file-manage":[function(require,module,exports){
...
},{"jquery-form":10,"jquery-validate":14}],"identity":[function(require,module,exports){
...
},{"jquery-form":10,"jquery-validate":14}],"index":[function(require,module,exports){
'use strict';
...
},{"./lib/product-preview":4,"jquery-validate":14}],"order":[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    indexFun: function indexFun() {
            ...
            (function () {
                ...
                $.ajax({
                    ...
                    $.each(imageList, function (i, n) {
                        var id = parseInt($(n).data('id'));
                        if (!$.isEmptyObject(data.images)) {
                            for (var _i2 in data.images) {
                                if (parseInt(_i2) === id) {
                                    $(n).removeClass('on').html('<a href="' + data.images[_i2] + '" target="_blank"><img src="' + data.images[_i2] + '?imageMogr2/thumbnail/24"/></a>');
                                } else if (!id) {
        ...
        {
            (function () {
                var modalSetStock = $('#modal-set-stock');
                var stock = modalSetStock.find('select[name=stock]');
                var sales = modalSetStock.find('select[name=sales]');

                var stockMinus = modalSetStock.find('.stock-minus');
                var stockPlus = modalSetStock.find('.stock-plus');
                ...
                save.click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function success(data) {
                            if (data.success) {
                                var updateStock = $('.set-stock.current').parents('.order-split').find('.update-stock');
    ...
    customerNameTypeAhead: function customerNameTypeAhead() {
    ...
    orderNameTypeAhead: function orderNameTypeAhead() {
        var _this2 = this;

        $('.name').each(function (i, n) {
            _this2.bindOrderNameTypeAhead($(n));
        });
    },
    bindOrderNameTypeAhead: function bindOrderNameTypeAhead(element) {
...
},{"bloodhound":6,"jquery-validate":14}],"product-book":[function(require,module,exports){
'use strict';
...
},{"bloodhound":6,"jquery-validate":14}],"product-brand":[function(require,module,exports){
'use strict';
...
},{"jquery-validate":14}],"product-category":[function(require,module,exports){
'use strict';
...
},{"jquery-validate":14}],"product":[function(require,module,exports){
'use strict';
...
},{"./lib/product-preview":4,"jquery-validate":14}],"purchase-contact":[function(require,module,exports){
'use strict';
...
},{"jquery-form":10,"jquery-validate":14}],"purchase":[function(require,module,exports){
'use strict';
...
},{"bloodhound":6,"jquery-validate":14}],"record-category":[function(require,module,exports){
'use strict';
...
},{"jquery-validate":14}],"record":[function(require,module,exports){
'use strict';
...
},{"jquery-form":10,"jquery-validate":14}],"remark":[function(require,module,exports){
'use strict';
...
},{"jquery-validate":14}],"sign":[function(require,module,exports){
'use strict';
...
},{"jquery-validate":14}],"taobao-mail-create":[function(require,module,exports){
'use strict';
