...
module.exports = {
    ...
    indexFun: function () {
        ...
        //删除productMethod
        let removeLink = $('.remove-product-translate');
        let modal = $('#confirm-remove-product-translate');
        ...
        removeLink.click(function() {
            ...
            modal.modal({
                ...
                onConfirm: function () {
                    ...
                    let productTranslateId = parseInt(item.data('id'));
                    if (item.data('state')) {
                        return false;
                    }
                    ...
                    $.ajax({
                        type:'post',
                        url:`/product-translate/remove/${productTranslateId}`,
                        success: function (data) {
                            ...
                            if (data.success) {
                                ...
                                }).find('.am-modal-bd').text('删除产品翻译成功!');
                            } else {
